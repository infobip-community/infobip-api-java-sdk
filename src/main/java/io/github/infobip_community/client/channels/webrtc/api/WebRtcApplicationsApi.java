...
import io.github.infobip_community.client.channels.webrtc.model.application.WebRtcApplication;
import io.github.infobip_community.client.channels.webrtc.model.application.WebRtcApplicationResponse;
import io.github.infobip_community.client.channels.webrtc.model.application.WebRtcApplicationResponses;
...
public final class WebRtcApplicationsApi {
    ...
    public ApiResponse<WebRtcApplicationResponse>
            saveWebRtcApplication(final WebRtcApplication webRtcApplication) throws ApiException {
    ...
    private Call getWebRtcApplicationsCall(final ApiCallback apiCallback) throws ApiException {
        ...
        return apiClient.buildCall(GET_WEBRTC_APPLICATIONS_ENDPOINT, null, HttpMethodType.GET,
    ...
    private Call saveWebRtcApplicationCall(final WebRtcApplication webRtcApplication,
        ...
        return apiClient.buildCall(SAVE_WEBRTC_APPLICATION_ENDPOINT, null, HttpMethodType.POST,
    ...
    private Call getWebRtcApplicationCall(final String id, final ApiCallback apiCallback)
        ...
        Map<String, String> httpHeaders = new HashMap<String, String>();
        httpHeaders.put(HttpHeader.ACCEPT, HttpHeader.APPLICATION_JSON);
        return apiClient.buildCall(getWebRtcApplicationEndpoint, null, HttpMethodType.GET,
                httpHeaders, null, apiCallback);
    }
    ...
    private Call updateWebRtcApplicationCall(final String id,
        ...
        httpHeaders.put(HttpHeader.ACCEPT, HttpHeader.APPLICATION_JSON);
        httpHeaders.put(HttpHeader.CONTENT_TYPE, HttpHeader.APPLICATION_JSON);
        return apiClient.buildCall(updateWebRtcApplicationEndpoint, null, HttpMethodType.PUT,
                httpHeaders, webRtcApplication, apiCallback);
    }
    ...
    private Call deleteWebRtcApplicationCall(final String id, final ApiCallback apiCallback)
        ...
        Map<String, String> httpHeaders = new HashMap<String, String>();
        httpHeaders.put(HttpHeader.ACCEPT, HttpHeader.APPLICATION_JSON);
        return apiClient.buildCall(deleteWebRtcApplicationEndpoint, null, HttpMethodType.DELETE,
                httpHeaders, null, apiCallback);
    }
}
