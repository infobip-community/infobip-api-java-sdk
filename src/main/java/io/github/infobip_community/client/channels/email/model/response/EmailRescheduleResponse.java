...
public final class EmailRescheduleResponse {
    ...
    public EmailRescheduleResponse() {}
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EmailRescheduleResponse)) {
            return false;
        }
        EmailRescheduleResponse other = (EmailRescheduleResponse) obj;
        if (bulkId == null) {
    ...
    public String toString() {
        return "EmailRescheduleResponse [bulkId=" + bulkId + ", sendAt=" + sendAt + "]";
    }
}
