...
public final class ReportResult {
    ...
    public String toString() {
        return "ReportResult [bulkId=" + bulkId + ", callbackData=" + callbackData + ", doneAt="
                + doneAt + ", error=" + error + ", from=" + from + ", mccMnc=" + mccMnc
                + ", messageId=" + messageId + ", price=" + price + ", sentAt=" + sentAt
                + ", smsCount=" + smsCount + ", status=" + status + ", to=" + to + "]";
    }
}
